    ...
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        className={cn(
          ...
          // NOTE - menu content
          "min-w-52 p-2 bg-white dark:bg-black text-on-base rounded-lg not-dark:shadow-md not-dark:shadow-on-base/10 ring-4 ring-base-300/30 dark:ring-base-300/80",
          className
        )}
